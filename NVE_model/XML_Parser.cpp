...
bool XMLParser::parseSimulationParams(std::string &file)
{
 ...
 const std::string XMLParser::DistributionEnum::distributionStrings[XMLParser::DistributionEnum::distCount] = {"uniform", "constant", "sequential",
                                                                                                               "exponential", "pareto", "weibull", "normal",
 ...
 XMLParser::DistributionEnum::DistributionEnum(XMLParser::Distributions dist, XMLParser* owner)
     : owner(owner)
{
...
XMLParser::DistributionEnum::DistributionEnum(int dist, XMLParser* owner)
    : owner(owner)
{
...
XMLParser::DistributionEnum::DistributionEnum(const std::string& distStr, XMLParser* owner)
    : owner(owner)
{
...
template <class T, class U, class V, class W> bool XMLParser::DistributionEnum::readCommaSeparatedString(const std::string &csvString,
                                                                                                         int paramCount, T& val1, U& val2, V& val3, W& val4)
{
      std::stringstream stream;
      stream << csvString;
